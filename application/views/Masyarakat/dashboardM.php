                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<?= base_url() ?>assets/sb-admin/img/undraw_posting_photo.svg"
                                            alt="...">
                                    </div>
                                    <h2>Selamat datang ke Aplikasi Pengaduan Masyarakat.<br></h2>
                                    <!-- <a target="_blank" rel="nofollow" href="<?= base_url('NewLPM/tutorial') ?>">
                                        <h4>Cara pemakaian &rarr;</h4>
                                    </a> -->
                                </div>
                            </div>
                        </div>
