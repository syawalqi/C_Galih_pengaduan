                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('Admin') ?>">
                                ...
                                <div class="form-group">
                                    <input value="<?= set_value('nama_petugas')?>" type="nama_petugas" name="nama_petugas" id="nama_petugas" class="form-control form-control-user" id="exampleInputnama_petugas" aria-describedby="nama_petugasHelp" placeholder="Enter nama ">
