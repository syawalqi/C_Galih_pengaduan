    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="<?= base_url ('NewLPM/landing') ?>">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Masyarakat <sup>Dashboard</sup></div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url ('NewLPM/landing') ?>">
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Subdata</a>
                        <a class="collapse-item" href="<?= base_url ('NewLPM/masyarakat') ?>">Masyarakat</a>
                    </div>
                </div>
            </li> -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url ('NewLPM/pengaduanbaru') ?>">Pengaduan</a>
                        <a class="collapse-item" href="<?= base_url ('NewLPM/pengaduan') ?>">Laporan</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Pengaduan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= number_format($pe)?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="card shadow mb-4 mt-4">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('NewLPM/insertpengaduan')?>" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input type="text" name="tgl_pengaduan" id="tgl_pengaduan" class="form-control"
                                            placeholder="Hari ini" value="<?= date('Y-m-d') ?>" disabled>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#kategori').change(function() {
                var id = $(this).val();
                $.ajax({
                    url: "<?php echo base_url()?>NewLPM/get_sub_kategori",
                    method: "POST",
                    data: {
                        id: id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<option value=' + data[i].subkategori + '>' + data[i]
                                .subkategori + '</option>';
                        }
